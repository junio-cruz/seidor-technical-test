...
`)}}});var K=o((zt,Z)=>{"use strict";Z.exports=function({schema:t,messages:e},i,n){let r=[],a=!1;return r.push(`
		var origValue = value;
...
`)}}});var W=o((Mt,G)=>{"use strict";G.exports=function({schema:t,messages:e,index:i},n,r){let a=[],s=t.instanceOf.name?t.instanceOf.name:"<UnknowClass>";return r.customs[i]?r.customs[i].schema=t:r.customs[i]={schema:t},a.push(`
...
`)}}});var Y=o((Lt,Q)=>{"use strict";Q.exports=function({schema:t,messages:e,index:i},n,r){let a=[];return a.push(`
		...
		return value;
	`),{source:a.join(`
`)}}});var te=o((Ht,ee)=>{"use strict";var at="(?=.*\\d)^(-?~1|~1-?)(([0-9]\\d{0,2}(~2\\d{3})*)|0)?(\\~3\\d{1,2})?$";ee.exports=function({schema:t,messages:e},i,n){let r=t.currencySymbol||null,a=t.thousandSeparator||",",s=t.decimalSeparator||".",u=t.customRegex,l=!t.symbolOptional,p=at.replace(/~1/g,r?`\\${r}${l?"":"?"}`:"").replace("~2",a).replace("~3",s),c=[];return c.push(`
		...
		return value;
	`),{source:c.join(`
`)}}});var ie=o((Jt,re)=>{"use strict";re.exports=function({schema:t,messages:e},i,n){let r=[],a=!1;return r.push(`
		var origValue = value;
	`),t.convert===!0&&(a=!0,r.push(`
		...
		return value;
	`),{sanitized:a,source:r.join(`
`)}}});var ne=o((Bt,ae)=>{"use strict";var nt=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,st=/^\S+@\S+\.\S+$/;ae.exports=function({schema:t,messages:e},i,n){let r=[],a=t.mode=="precise"?nt:st,s=!1;return r.push(`
...
`)}}});var le=o((Xt,se)=>{"use strict";se.exports=function({schema:t,messages:e},i,n){return{source:`
			if (${JSON.stringify(t.values||[])}.indexOf(value) === -1)
				${this.makeError({type:"enumValue",expected:'"'+t.values.join(", ")+'"',actual:"value",messages:e})}
			
			return value;
		`}}});var oe=o((Zt,ue)=>{"use strict";ue.exports=function({schema:t,messages:e},i,n){let r=[];return t.field?(t.strict?r.push(`
		...
		return value;
	`),{source:r.join(`
`)}}});var ce=o((Kt,pe)=>{"use strict";pe.exports=function({schema:e,messages:i},n,r){let a=[];return a.push(`
	...
	`),e.remove?a.push(`
		...
		return value;
	`),{source:a.join(`
`)}}});var de=o((Gt,fe)=>{"use strict";fe.exports=function({schema:t,messages:e},i,n){return{source:`
...
`)}}});var ve=o((Qt,me)=>{"use strict";me.exports=function({schema:t,messages:e},i,n){let r=[];r.push(`
	...
	`),t.min!=null&&r.push(`
		...
		return value;
	`),{sanitized:a,source:r.join(`
`)}}});var be=o((Yt,ge)=>{"use strict";var lt=/^[_$a-zA-Z][_$a-zA-Z0-9]*$/,ut=/["'\\\n\r\u2028\u2029]/g;function T(t){return t.replace(ut,function(e){switch(e){case'"':case"'":case"\\":return"\\"+e;case`
`:return"\\n";case"\r":return"\\r";case"\u2028":return"\\u2028";case"\u2029":return"\\u2029"}})}ge.exports=function({schema:t,messages:e},i,n){let r=[];r.push(`
	...
	`);let a=t.properties||t.props;if(a){r.push("var parentObj = value;"),r.push("var parentField = field;");let s=Object.keys(a);for(let u=0;u<s.length;u++){let l=s[u],p=T(l),c=lt.test(p)?`.${p}`:`['${p}']`,f=`parentObj${c}`,U=(i?i+".":"")+l,V=a[l].label,Je=V?`'${T(V)}'`:void 0;r.push(`
// Field: ${T(U)}`),r.push(`field = parentField ? parentField + "${c}" : "${p}";`),r.push(`value = ${f};`),r.push(`label = ${Je}`);let Be=this.getRuleFromSchema(a[l]),Xe=`
				${f} = ${n.async?"await ":""}context.fn[%%INDEX%%](value, field, parentObj, errors, context, label);
			`;r.push(this.compileRule(Be,n,U,Xe,f)),this.opts.haltOnFirstError===!0&&r.push("if (errors.length) return parentObj;")}if(t.strict){let u=Object.keys(a);r.push(`
				field = parentField;
				var invalidProps = [];
...
`)}}});var Ne=o((nr,Ae)=>{"use strict";var vt=/^([0-9a-f]{8}-[0-9a-f]{4}-[1-6][0-9a-f]{3}-[0-9a-f]{4}-[0-9a-f]{12}|[0]{8}-[0]{4}-[0]{4}-[0]{4}-[0]{12})$/i;Ae.exports=function({schema:t,messages:e},i){let n=[];return n.push(`
	...
	`),parseInt(t.version)<7&&n.push(`
		...
		return value;
	`),{source:n.join(`
`)}}});var Ve=o((sr,Ue)=>{"use strict";var gt=/^((([a-f0-9][a-f0-9]+[-]){5}|([a-f0-9][a-f0-9]+[:]){5})([a-f0-9][a-f0-9])$)|(^([a-f0-9][a-f0-9][a-f0-9][a-f0-9]+[.]){2}([a-f0-9][a-f0-9][a-f0-9][a-f0-9]))$/i;Ue.exports=function({schema:t,messages:e},i,n){return{source:`
			if (typeof value !== "string") {
				${this.makeError({type:"string",actual:"value",messages:e})}
				return value;
			}
			...
			return value;
		`}}});var Ce=o((lr,qe)=>{"use strict";qe.exports=function({schema:t,messages:e},i,n){return{source:`
			if (typeof value !== "string") {
				${this.makeError({type:"string",actual:"value",messages:e})}
				return value;
			}
...
`)}getRuleFromSchema(e){e=this.resolveType(e);let i=this.aliases[e.type];i&&(delete e.type,e=d(e,i,{skipIfExist:!0}));let n=this.rules[e.type];if(!n)throw new Error("Invalid '"+e.type+"' type in validator schema.");return{messages:Object.assign({},this.messages,e.messages),schema:d(e,this.defaults[e.type],{skipIfExist:!0}),ruleFunction:n}}parseShortHand(e){let i=e.split("|").map(a=>a.trim()),n=i[0],r;return n.endsWith("[]")?r=this.getRuleFromSchema({type:"array",items:n.slice(0,-2)}).schema:r={type:i[0]},i.slice(1).map(a=>{let s=a.indexOf(":");if(s!==-1){let u=a.substr(0,s).trim(),l=a.substr(s+1).trim();l==="true"||l==="false"?l=l==="true":Number.isNaN(Number(l))||(l=Number(l)),r[u]=l}else a.startsWith("no-")?r[a.slice(3)]=!1:r[a]=!0}),r}makeError({type:e,field:i,expected:n,actual:r,messages:a}){let s={type:`"${e}"`,message:`"${a[e]}"`};return i?s.field=`"${i}"`:s.field="field",n!=null&&(s.expected=n),r!=null&&(s.actual=r),s.label="label",`errors.push({ ${Object.keys(s).map(l=>`${l}: ${s[l]}`).join(", ")} });`}makeCustomValidator({vName:e="value",fnName:i="custom",ruleIndex:n,path:r,schema:a,context:s,messages:u}){let l="rule"+n,p="fnCustomErrors"+n;if(typeof a[i]=="function"){if(s.customs[n]?(s.customs[n].messages=u,s.customs[n].schema=a):s.customs[n]={messages:u,schema:a},this.opts.useNewCustomCheckerFunction)return`
		...
		`}return""}add(e,i){this.rules[e]=i}addMessage(e,i){this.messages[e]=i}alias(e,i){if(this.rules[e])throw new Error("Alias name must not be a rule name");this.aliases[e]=i}plugin(e){if(typeof e!="function")throw new Error("Plugin fn type must be function");return e(this)}resolveType(e){if(typeof e=="string")e=this.parseShortHand(e);else if(Array.isArray(e)){if(e.length===0)throw new Error("Invalid schema.");e={type:"multi",rules:e},e.rules.map(a=>this.getRuleFromSchema(a)).every(a=>a.schema.optional===!0)&&(e.optional=!0);let n=!this.opts.considerNullAsAValue;e.rules.map(a=>this.getRuleFromSchema(a)).every(a=>a.schema.nullable===n)&&(e.nullable=n)}if(e.$$type){let i=e.$$type,n=this.getRuleFromSchema(i).schema;delete e.$$type;let r=Object.assign({},e);for(let a in e)delete e[a];d(e,n,{skipIfExist:!0}),e.props=r}return e}normalize(e){let i=this.resolveType(e);if(this.aliases[i.type]&&(i=d(i,this.normalize(this.aliases[i.type]),{skipIfExists:!0})),i=d(i,this.defaults[i.type],{skipIfExist:!0}),i.type==="multi")return i.rules=i.rules.map(n=>this.normalize(n)),i.optional=i.rules.every(n=>n.optional===!0),i;if(i.type==="array")return i.items=this.normalize(i.items),i;if(i.type==="object"&&i.props&&Object.entries(i.props).forEach(([n,r])=>i.props[n]=this.normalize(r)),typeof e=="object")if(e.type){let n=this.normalize(e.type);d(i,n,{skipIfExists:!0})}else Object.entries(e).forEach(([n,r])=>i[n]=this.normalize(r));return i}};Fe.exports=w});var Le=o((pr,Me)=>{Me.exports=ze()});var Ot={};Ye(Ot,{DeleteUserController:()=>A,default:()=>kt});module.exports=tt(Ot);(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},e=new Error().stack;e&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[e]="ff078d09-9b1e-4666-a106-bb9bb2d29570",t._sentryDebugIdIdentifier="sentry-dbid-ff078d09-9b1e-4666-a106-bb9bb2d29570")}catch{}})();var y=class t extends Error{constructor(i,n,r,a=500){super(i);this.message=i;this.data=n;this.stack=r;this.statusCode=a;this.name="HttpError",Object.setPrototypeOf(this,t.prototype),Error.captureStackTrace(this,t)}},m=class t extends y{constructor(i,n="HttpBadRequestError",r,a="BAD_REQUEST",s=400){super(a,i,r,s);this.data=i;this.name=n;this.stack=r;this.message=a;this.statusCode=s;Object.setPrototypeOf(this,t.prototype),Error.captureStackTrace(this,t)}};var v=class t extends y{constructor(i,n,r="HttpNotFoundError",a="NOT_FOUND",s=404){super(a,i,n,s);this.data=i;this.stack=n;this.name=r;this.message=a;this.statusCode=s;Object.setPrototypeOf(this,t.prototype),Error.captureStackTrace(this,t)}};var S=class{constructor(e,i){this.body=e;this.statusCode=i}},g=class t extends S{constructor(i){super(i,200);this.body=i;Object.setPrototypeOf(this,t.prototype),Error.captureStackTrace(this,t)}};var k=class{constructor(e){this.entityModel=e;this.clientSession=e}clientSession;start(){return this.clientSession=[],!!this.clientSession}getSession(){if(this.clientSession)return this.clientSession;throw new Error("START_DATABASE_ERROR")}updateSession(e){return this.clientSession=e,this.clientSession}},O=new k([]);var b=class{async execute(e){let i,n=O.getSession(),r=n.find(s=>s.user_id===e.user_id||e.user_id===s.email)||null;if(!r)return r;let a=n.map(s=>s.user_id===e.user_id&&s.user_id===e.user_id?(i={user_id:e.user_id,...e.to_update,email:s.email,created_at:s.created_at},i):s);return O.updateSession(a),i}};var x=class{constructor(e,i=new b){this.logger=e;this.updateUserRepository=i;this.logger=this.logger.getChild("DeleteUserUseCase")}async execute(e){this.logger.debug("execute input",JSON.stringify(e));let i=await this.updateUserRepository.execute({user_id:e.user_id,to_update:{deleted_at:new Date}});return this.logger.debug("delete user repository response",i),this.logger.debug("execute output",i),i}};var C=({optional:t=!1})=>({type:"uuid",version:4,optional:t});var I=t=>({user_id:t.user_id,name:t.name,email:t.email,email_verified:t.email_verified,role:t.role,languages:t.languages,created_at:t.created_at,bio:t.bio||void 0,photo_url:t.photo_url||void 0,deleted_at:t.deleted_at||void 0,approved_at:t.approved_at});var He=et(Le()),E=class{async validate(e,i){let r=await new He.default({useNewCustomCheckerFunction:!0}).validate(e,i);return r===!0?{isValid:r,errors:[]}:{isValid:!1,errors:r.map(a=>a.message||`${a.field} - ${a.type}`)}}};var A=class{constructor(e,i=new E,n=new x(e)){this.logger=e;this.requestValidator=i;this.deleteUserUseCase=n;this.logger=this.logger.getChild("DeleteUserController")}async handle(e){let{user_id:i}=e.params,n=await this.requestValidator.validate({user_id:i},{user_id:C({optional:!1})});if(!n.isValid)return new m(n.errors);let r=await this.deleteUserUseCase.execute({user_id:i});return r?new g(I(r)):new v("USER_NOT_FOUND")}};var kt=void 0;0&&(module.exports={DeleteUserController});
